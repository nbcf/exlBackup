 ...
 * CEL: 8115-7490
 */
public class WConfINI_Ftp {
    
    public static void SalvarConfFtp(String sftp){
        
  File dirFTP   =   new File ("C:\\Windows\\3.nbx");
  FileOutputStream fluxInURL      =       null;
  ObjectOutputStream fluxOutURL   =       null;
  
                 Object c1 = (Object)sftp;
               
                          try
                                {

                              fluxInURL = new FileOutputStream(dirFTP);
